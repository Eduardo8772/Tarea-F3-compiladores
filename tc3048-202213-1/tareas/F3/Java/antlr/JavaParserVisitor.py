...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by JavaParser#intL.
    def visitIntL(self, ctx:JavaParser.IntLContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#floatL.
    def visitFloatL(self, ctx:JavaParser.FloatLContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#chrL.
    def visitChrL(self, ctx:JavaParser.ChrLContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#strL.
    def visitStrL(self, ctx:JavaParser.StrLContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#boolL.
    def visitBoolL(self, ctx:JavaParser.BoolLContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#nullL.
    def visitNullL(self, ctx:JavaParser.NullLContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#textB.
    def visitTextB(self, ctx:JavaParser.TextBContext):
        return self.visitChildren(ctx)
