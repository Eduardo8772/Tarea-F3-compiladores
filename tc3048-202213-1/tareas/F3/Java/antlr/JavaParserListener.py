# Generated from /Users/eduardo/Desktop/tc3048-202213-1/tareas/F3/Java/antlr/JavaParser.g4 by ANTLR 4.10.1
from antlr4 import *
...
class JavaParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JavaParser#intL.
    def enterIntL(self, ctx:JavaParser.IntLContext):
        pass

    # Exit a parse tree produced by JavaParser#intL.
    def exitIntL(self, ctx:JavaParser.IntLContext):
        pass


    # Enter a parse tree produced by JavaParser#floatL.
    def enterFloatL(self, ctx:JavaParser.FloatLContext):
        pass

    # Exit a parse tree produced by JavaParser#floatL.
    def exitFloatL(self, ctx:JavaParser.FloatLContext):
        pass


    # Enter a parse tree produced by JavaParser#chrL.
    def enterChrL(self, ctx:JavaParser.ChrLContext):
        pass

    # Exit a parse tree produced by JavaParser#chrL.
    def exitChrL(self, ctx:JavaParser.ChrLContext):
        pass
    ...
    # Exit a parse tree produced by JavaParser#strL.
    def exitStrL(self, ctx:JavaParser.StrLContext):
        pass


    # Enter a parse tree produced by JavaParser#boolL.
    def enterBoolL(self, ctx:JavaParser.BoolLContext):
        pass

    # Exit a parse tree produced by JavaParser#boolL.
    def exitBoolL(self, ctx:JavaParser.BoolLContext):
        pass


    # Enter a parse tree produced by JavaParser#nullL.
    def enterNullL(self, ctx:JavaParser.NullLContext):
        pass

    # Exit a parse tree produced by JavaParser#nullL.
    def exitNullL(self, ctx:JavaParser.NullLContext):
        pass


    # Enter a parse tree produced by JavaParser#textB.
    def enterTextB(self, ctx:JavaParser.TextBContext):
        pass

    # Exit a parse tree produced by JavaParser#textB.
    def exitTextB(self, ctx:JavaParser.TextBContext):
        pass
